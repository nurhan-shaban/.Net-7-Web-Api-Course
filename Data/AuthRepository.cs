...
namespace Data
{
    public class AuthRepository : IAuthRepository
    {
        ...
        public AuthRepository(DataContext data,IConfiguration configuration)
        {
            _data = data;
        ...
        public async Task<ServiceResponse<string>> Login(string username, string password)
        {
            ...
            var user = await _data.Users.FirstOrDefaultAsync(x => x.Username.ToLower().Equals(username.ToLower()));
            if(user is null)
            {
        ...
        private string CreateToken(User user)
        {
            ...
            if(appSettingsToken is null)
                throw new Exception("Appseting is null!;");
